...
public class TSPList {
    ...
    double calculateTotalDistance() {   // Подсчёт итоговой длины пути между городами
        double sum = 0.0;
    ...
    TSPList[] crossover(final TSPList other) {
        ...
        return new TSPList[] { new TSPList(crossoverOne), 
                            new TSPList(crossoverTwo) };
    }
